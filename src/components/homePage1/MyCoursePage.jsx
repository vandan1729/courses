...
import MyCourseCardData from "./MyCourseCardData";
    ...
    <>
      ...
      <div className="myCoursetTopLayer">
        ...
        <div className="myCoursetTopLayerDropDown">
          <button onClick={() => toggleDropdown('dropdown1')} className="myCoursetTopLayerDropDownToggle">
            All Rated {openDropdown === 'dropdown1' ? <IoIosArrowUp /> : <IoIosArrowDown />}
          </button>

          <button onClick={() => toggleDropdown('dropdown2')} className="myCoursetTopLayerDropDownToggle">
            Recently added {openDropdown === 'dropdown2' ? <IoIosArrowUp /> : <IoIosArrowDown />}
          </button>
